...
public class typescriptparser extends Parser {
	...
	public static final int
		...
		OR=56, BACKTICK=57, LINE_COMMENT_HTML=58, BLOCK_COMMENT_HTML=59, BACKTICK_HTML=60, 
		TAG_OPEN_START_HTML=61, TAG_CLOSE_START_HTML=62, TAG_CLOSE_END_HTML=63, 
		TAG_END_HTML=64, ATTRIBUTE_EQUALS_HTML=65, STRING_HTML=66, STRUCTURAL_DIR_HTML=67, 
		BINDING_HTML=68, EVENT_BINDING_HTML=69, NEGATION_HTML=70, COLON_HTML=71, 
		INTERPOLATION_START_HTML=72, INTERPOLATION_END_HTML=73, DOT_HTML=74, NAME_HTML=75, 
		END_TEMPLATE=76, WS_HTML=77, BACKTICK_CSS=78, COLON_CSS=79, COMMA_CSS=80, 
		OPEN_LIST=81, CLOSE_LIST=82, DOT_CSS=83, SEMICOLON_CSS=84, LBRACE_CSS=85, 
		RBRACE_CSS=86, PERCENT=87, WS_CSS=88, LINE_COMMENT_CSS=89, BLOCK_COMMENT_CSS=90, 
		PX=91, EM=92, REM=93, ID_CSS=94;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'string'", "'number'", "'boolean'", "'any'", "'void'", null, null, null, 
			null, null, "'this'", null, "'+'", "'-'", "'*'", "'/'", "'<'", null, 
			null, "'!='", "'('", "')'", null, null, "'true'", "'false'", null, null, 
			null, null, null, null, "'@'", "'as'", "'type'", null, null, "'|'", null, 
			null, null, null, null, null, null, "'/>'", null, null, null, null, null, 
			"'!'", null, "'{{'", "'}}'", null, null, "'`,'", null, null, null, null, 
			null, null, null, null, null, null, "'%'", null, null, null, "'px'", 
			"'em'", "'rem'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DECORATOR", "AS", "TYPE", "LBRACKET", "RBRACKET", "OR", "BACKTICK", 
			"LINE_COMMENT_HTML", "BLOCK_COMMENT_HTML", "BACKTICK_HTML", "TAG_OPEN_START_HTML", 
			"TAG_CLOSE_START_HTML", "TAG_CLOSE_END_HTML", "TAG_END_HTML", "ATTRIBUTE_EQUALS_HTML", 
			"STRING_HTML", "STRUCTURAL_DIR_HTML", "BINDING_HTML", "EVENT_BINDING_HTML", 
			"NEGATION_HTML", "COLON_HTML", "INTERPOLATION_START_HTML", "INTERPOLATION_END_HTML", 
			"DOT_HTML", "NAME_HTML", "END_TEMPLATE", "WS_HTML", "BACKTICK_CSS", "COLON_CSS", 
	...
	public final TemplateContext template() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 61)) & ~0x3f) == 0 && ((1L << (_la - 61)) & 18433L) != 0)) {
				{
				{
				setState(140);
				element();
	...
	public final OpeningTagContext openingTag() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 263L) != 0)) {
				{
				{
				setState(398);
				attributes();
